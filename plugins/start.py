...
async def stream_start(client, message):
    ...
    await message.reply_text(text=msg_text.format(get_name(log_msg), humanbytes(get_media_file_size(message))), quote=True, disable_web_page_preview=True, reply_markup=rm)
