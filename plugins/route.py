...
# --- Watch Page Handler (Renders HTML) ---
...
async def stream_handler(request: web.Request):
    try:
        ...
        if match:
            ...
            # Safer extraction of ID if path doesn't match hash/ID structure
            try:
...
# --- Media Stream Handler (Serves File Data) ---
...
# --- Core Media Streaming Logic ---
async def media_streamer(request: web.Request, id: int, secure_hash: str):
    # Check if Range header was sent to determine HTTP status later
    ...
    # Use aiohttp's built-in Range header parsing for robust handling
